...
describe('getASIN', () => {
  ...
  it('should get a 10-digit ASIN from a string', () => {
    const urls = [
  ...
  it('should match 13-digit ISBN', () => {
    const url = 'http://url.com/1231231231234/dp/ISBN123456789/blah'
    expect(getASIN(url)).toEqual('ISBN123456789')
  })
})
